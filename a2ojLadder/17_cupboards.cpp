/**
 *      file    :  17_cupboards.cpp 
 *      author  :  techiedheeraj
 *      created :  2021 Jun 10 16:12:01 
 *      lastMod :  Thu 10 Jun 16:12:01 2021 
 **/
...
inline void solve() {
  ...
  pair<int, int>l= make_pair(0, 0); //first maintains 0 count, second 1's count
  ...
  res+=min(l.first, l.second);
  res+=min(r.first, r.second);
  cout << res;
}
