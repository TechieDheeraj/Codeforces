/**
 *      file    :  53_stringTask.cpp 
 *      author  :  techiedheeraj
 *      created :  2021 Jul 04 15:13:14 
 *      lastMod :  Sun  4 Jul 15:13:14 2021 
 **/
...
inline void solve() {
  ...
  vector<char>st{'a', 'o', 'y', 'e', 'u', 'i', 'A', 'O', 'Y', 'E', 'U', 'I'};

  for (int i =0; i<s.length(); ++i) {
    if ((std::find(st.begin(), st.end(), s[i])) != st.end())
      continue;
    if (isupper(s[i]))
      s[i]+=32;
